...
export const socialLinks = [
  { platform: 'github' as const, url: 'https://github.com/nickrwann', label: 'GitHub Profile' },
  { platform: 'linkedin' as const, url: 'https://www.linkedin.com/in/nick-wanner/', label: 'LinkedIn Profile' },
  { platform: 'instagram' as const, url: 'https://www.instagram.com/nickwinner/?igsh=dzFjemdhdm1hczdo&utm_source=qr#', label: 'Instagram Profile' },
];
